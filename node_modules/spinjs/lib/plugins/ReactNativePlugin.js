...
var ReactNativePlugin = (function () {
    ...
    ReactNativePlugin.prototype.configure = function (builder, spin) {
        ...
        if (stack.hasAll(['react-native', 'webpack'])) {
            ...
            var babelrc = new UPFinder_1.default(builder).find(['.babelrc.native']);
            ...
            builder.config.module.rules.push({
                ...
                use: {
                    ...
                    options: spin.createConfig(builder, 'babel', __assign({ babelrc: false, cacheDirectory: cacheDirectory }, defaultConfig))
                }
            });
